// You are give a string that represents domino tiles, you must return the longest possible chain that can be done using domino . example : "3-4;4-4;1-2;3-1;2-5"; here you should return 5;
